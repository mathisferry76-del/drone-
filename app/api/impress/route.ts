...
- Au-delà du nom du modèle, respecte aussi précisément la GÉNÉRATION et la FINITION/le PACK PERFORMANCE exacts nommés par l'utilisateur, pas juste la plateforme générale du modèle — une "M4 Competition" a un pare-chocs avant, un becquet, des jantes et des sorties d'échappement spécifiques à cette finition, différents d'une M4 de base ou d'une autre génération de M4 (calandre plus ou moins large selon l'année, forme des phares) ; une "RS6 Performance" a des étriers de frein, un becquet et des touches visuelles différents d'une RS6 standard. Ne rends pas un modèle générique de la bonne plateforme avec juste le bon badge collé dessus — les éléments visuels distinctifs de la finition/du pack sport exact demandé doivent être présents.
