  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center overflow-hidden">
      ...
      <div style={{ perspective: 900 }}>
        <motion.div
          className="flex aspect-video w-40 items-center justify-center rounded-2xl border border-yellow-400/50 bg-gradient-to-br from-zinc-800 to-zinc-900 shadow-[0_0_45px_-8px_theme(colors.yellow.400/60%)] sm:w-52"
        ...
        >
          <span className="px-3 text-center text-xs font-bold text-yellow-300 sm:text-sm">
            {label}
          </span>
        </motion.div>
      </div>
